...
public class FindFileInZipFile {
	...
	static BufferedImage bgTileSprite;
    public BufferedImage getImage(String filePath, String searchFileName){
         try{
               ...
               /* if(entry.getName().toLowerCase().indexOf(searchFileName) != -1)
                {
                        ...
                        if( data[2].equalsIgnoreCase("icon.png") || entry.getName().contains("launcher")){
                            ...
                            try
                            {
                                ...
                                System.out.println(bgTileSprite);
                            }
                            catch (IOException ex)
                            {
                                System.err.println("Could not convert zipped image bytearray to a BufferedImage."+ex);
                            }
                         break;
                        }
            ...
            if(found == false){
            	 log.info("File :" + searchFileName + " Not Found Inside Zip File: " + sourceZipFile.getName());
            }
            //close the zip file
            sourceZipFile.close();
